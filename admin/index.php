...
require_once dirname(__DIR__) . '/private/model/Partner.class.php';
...
if($isLoginRequest)
{
    ...
    $result = $dataService->getAdminByEmailAndPassword($email, $password);

    if(is_object($result) && get_class($result) == 'Admin')
    {
        loginAdmin($result);
        header('Location: /admin/panel.php');
    }
